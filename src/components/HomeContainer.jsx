      ...
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        <div className="flex items-center gap-2 justify-center bg-orange-100 px-4 py-1 rounded-full">
          ...
          <div className="w-8 h-8 bg-white rounded-full overflow-hidden drop-shadow-xl">
            <img src={Delivery} classNam="w-full h-full object-contain" alt="delivery" />
          </div>
        </div>
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fuga, assumenda ex! Vero unde minus libero aut, doloribus repudiandae sed deleniti magni omnis itaque. Laudantium nam soluta iste repudiandae ea et. 
        </p>
